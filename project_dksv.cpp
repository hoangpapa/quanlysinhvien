...
void MoLopTinChi(List_LTC& dsltc, treeMH& root) {
    ...
    do {
        ...
        cout << "4. In danh sach lop tin chi.\n";
        cout << "5. Huy lop tin chi.\n";
        cout << "6. Thoat\n";
...
int main() {
    ...
    int luaChon;
    do {
        cout << "\n=== MENU QUAN LY DIEM SINH VIEN THEO HE TIN CHI ===\n";
        cout << "1. Lop Tin Chi.\n";
        cout << "2. Nhap lop - Nhap sinh vien.\n";
        cout << "3. Nhap mon hoc.\n";
        cout << "4. Sinh vien dang ky lop tin chi.\n";
        cout << "5. Nhap-In Diem sinh vien.\n";
        cout << "0. Thoat\n";
        luaChon = stoi(nhapChuoiSo_2("Nhap lua chon: "));
